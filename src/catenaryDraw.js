...
CD.fancyPoleMaker = function(spec) {
  ...
  fancyPoleProto.x = 0;
  fancyPoleProto.y = 0;
  fancyPoleProto.height = 200;
  fancyPoleProto.width = 10;
  fancyPoleProto.svgTag = "g";
  ...
  newFancyPole.updateSVG = function() {
    fancyPoleProto.updateSVG.call(this);
    this.svgElement.innerHTML = '<image xlink:href="img/Wifi_symbol.svg" x="'+(this.x-this.width/2)+'" y="'+(-(this.y+this.height))+'" height="'+this.height+'" width="'+this.width+'"/>';
  }
  return newFancyPole;
} 
